            ...
            <div class="card-body">
                <div class="row g-4">
                    ...
                    <div class="col-md-6">
                        ...
                        value="{{ old('nombre', $presentacione->caracteristicas->nombre) }}">
                        @error('nombre')
                    ...
                    <div class="col-12">
                        ...
                        <textarea name="descripcion" id="descripcion" rows="3" class="form-control">{{ old('descripcion', $presentacione->caracteristicas->descripcion) }}</textarea>
                        @error('descripcion')
                            <small class="text-danger">{{ '*' . $message }}</small>
                        @enderror
                    </div>
